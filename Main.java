...
class Main {
  public static void main(String[] args) {
    System.out.println("Time to make a stable!");
    Stable s = new Stable();
    ...
    for(int i = 0; i < s.arrayList.size(); i++){
      System.out.println("Horse #" + (i+1) + " Name: " + s.arrayList.get(i).getName() + " Weight: " + s.arrayList.get(i).getWeight() + " Tame: " + s.arrayList.get(i).getTame());
    }
